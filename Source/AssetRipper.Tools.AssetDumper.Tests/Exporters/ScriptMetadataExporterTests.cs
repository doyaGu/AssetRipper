...
/// <summary>
/// Tests for ScriptMetadataExporter class.
...
public class ScriptMetadataExporterTests : IDisposable
{
	...
	public void Constructor_WithValidParameters_ShouldInitialize()
	{
		...
		// Act
		var exporter = new ScriptMetadataExporter(options, CompressionKind.None, enableIndex: false);
	...
	{
		// Act & Assert
		Action act = () => new ScriptMetadataExporter(null!, CompressionKind.None, enableIndex: false);
	...
	internal void Constructor_WithDifferentCompressionKinds_ShouldInitialize(CompressionKind compressionKind)
	{
		...
		// Act
		var exporter = new ScriptMetadataExporter(options, compressionKind, enableIndex: false);
	...
	public void Constructor_WithDifferentIndexSettings_ShouldInitialize(bool enableIndex)
	{
		...
		// Act
		var exporter = new ScriptMetadataExporter(options, CompressionKind.None, enableIndex);
