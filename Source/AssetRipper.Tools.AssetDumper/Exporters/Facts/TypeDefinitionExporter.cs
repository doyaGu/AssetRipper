...
/// </summary>
internal sealed class TypeDefinitionExporter
{
	...
	public TypeDefinitionExporter(Options options, CompressionKind compressionKind, bool enableIndex)
	{
	...
	{
		// Use same logic as AssemblyExporter for consistency
